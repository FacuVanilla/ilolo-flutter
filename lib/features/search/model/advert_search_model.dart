...
class Image {
  ...
  List<AdvertSearchModel> advertsToList(jsonData) {
    return (jsonData as List)
      .map((data) => AdvertSearchModel(
            id: data['id'],
            userId: data['user_id'],
            ...
            badge: data['badge'],
            // properties: data.containsKey('properties') ? (data['properties'] as List)
