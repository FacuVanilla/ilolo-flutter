...
class _SellScreenState extends State<SellScreen> {
  ...
  findSubcategoryById() {
    for (var category in context.read<FormDataRepository>().formDataCategories) {
      for (var subcategory in category.subcategories) {
        if (subcategory.id.toString() == context.watch<PostAdRepository>().subCategoryId) {
          subcategory.properties.isEmpty
              ? setState(() {
                  showProperty = false;
                  properties = [];
                  selectedProperties = {};
  ...
  Widget build(BuildContext context) {
    final String subCategoryName = context.watch<PostAdRepository>().subCategoryName;
    final String lga = context.watch<PostAdRepository>().lga;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          categoryController.text.isEmpty || locationController.text.isEmpty || titleController.text.isEmpty || priceController.text.isEmpty
              ? const SizedBox()
              : TextButton(
                  onPressed: () {},
                  child: const Text(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomTextFormField(
                                  ...
                                  suffixIcon1: const Icon(Icons.arrow_forward_ios_rounded, size: 16),
                                  readOnly: true,
                                  leftRightPadding: 0.0,
                                          ...
                                          : () async {
                                              if (_formKey.currentState!.validate()) {
                                                ...
                                                Map<String, dynamic> data = {
                                                  ...
                                                  "category": providerData.categoryId,
                                                  "subcategory": providerData.subCategoryId,
                                                  "state": providerData.state,
                                                  "lga": providerData.lga,
                                                ...
                                                // print(data);
                                                await providerData.postAdvert(data, context);
